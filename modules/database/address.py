...
def new_address(street: str, number: str, neighborhood: str, postal_code: str, city: str, ID_user: int) -> bool:
    ...
    with agora.cursor() as cursor:
        cursor.execute("INSERT INTO direccion(Calle, Numero, Colonia, Codigo_Postal, Ciudad, ID_Usuario) VALUES (%s, %s, %s, %s, %s, %s)", 
                       (street, number, neighborhood, postal_code, city, ID_user))
